...
import org.example.marketingimageapiserver.dto.InfluencerProfileImageMetadataWithUrl
import org.example.marketingimageapiserver.dto.SaveInfluencerProfileImageResult
...
import org.example.marketingimageapiserver.repository.InfluencerProfileImageMetaRepository
...
class InfluencerProfileImageService(
    private val influencerProfileImageMetaRepository: InfluencerProfileImageMetaRepository,
    ...
    fun saveInfluencerProfileImage(
        meta: UploadInfluencerProfileImageApiRequest,
        file: MultipartFile
        ...
        return transaction {
            ...
            val userType = UserType.INFLUENCER
            ...
            try {
                ...
                val createdId = influencerProfileImageMetaRepository.saveInfluencerProfileImageMetadata(
                    InfluencerProfileImageMetadata.of(
                        userId = meta.userId,
                        profileInfluencerDraftId = meta.influencerProfileDraftId,
                ...
                SaveInfluencerProfileImageResult.of(
                    id = createdId,
                ...
                throw S3UploadException(
                    logics = "InfluencerProfileImageService.saveInfluencerProfileImage",
                ...
                throw RuntimeException("Failed to save influencer profile image: ${e.message}", e)
            }
        }
    }

    fun getInfluencerProfileImageByUserId(userId: String, userType: String): List<InfluencerProfileImageMetadataWithUrl> {
        return transaction {
            val influencerProfileImageMetadataEntities: List<InfluencerProfileImageMetadataEntity> =
                influencerProfileImageMetaRepository.findInfluencerProfileImageByUserId(userId)

            influencerProfileImageMetadataEntities.map { entity ->
                ...
                InfluencerProfileImageMetadataWithUrl.of(
