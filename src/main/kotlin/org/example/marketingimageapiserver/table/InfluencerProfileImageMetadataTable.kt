...
object InfluencerProfileImageMetadataTable : BaseDateLongIdTable("influencer_profile_image_metadata") {
    val userId: Column<String> = varchar("user_id", 255)
    val profileInfluencerDraftId: Column<Long?> = long("profile_influencer_draft_id").nullable()
